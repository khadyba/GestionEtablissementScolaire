...
<div class="container">
    ...
    <small id="password-error" class="text-danger" style="display: none;">Mot de passe faible</small>
</div>
...
<script>
    ...
    passwordInput.addEventListener('input', function () {
        if (passwordInput.value.length < 6) {
            // Ajouter la classe "is-invalid" pour mettre l'input en rouge
            passwordInput.classList.add('is-invalid');
            // Afficher le message d'erreur
            passwordError.style.display = 'block';
        } else {
            // Supprimer la classe "is-invalid" si la validation est bonne
