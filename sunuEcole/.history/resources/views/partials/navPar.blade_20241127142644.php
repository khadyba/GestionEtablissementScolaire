  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="{{ route('parents.dashboard') }}">Espace Personnel</a>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white" href="{{ route('parents.profile.edit') }}">Modifier Profile</a>
        </li>
