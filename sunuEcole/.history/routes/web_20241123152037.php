...
Route::middleware(['auth', 'checkProfileCompletion'])->group(function () {  
    ...
    Route::middleware('professor')->prefix('professeurs')->name('professeurs.')->group(function () {
        ...
        Route::get('/fomulaire/modifications/password', [UsersController::class,'editpassword'])->name('formulaire.modifications');
        Route::put('/modifer/password', [UsersController::class, 'updatePassword'])->name('update.password');
    });
    ...
    Route::middleware('student')->prefix('eleves')->name('eleves.')->group(function () {
        ...
        Route::get('/cours/download/{id}', [ElevesCoursController::class, 'download'])->name('cours.download');
