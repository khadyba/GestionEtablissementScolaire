...
<div class="container my-4">
    <div class="row">
        <div class="col-md-8">
            <h1 class="mb-4">Liste des Cours de la classe {{ $classe->nom }}</h1>
                    ...
                    <tbody>
                        @foreach ($cours as $coursItem)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('professeurs.cours.detail.prof', $coursItem->id) }}" class="btn btn-info btn-sm">Voir détails</a>
        ...
        <div class="col-md-4">
            <!-- Placez l'image ici -->
            <img src="{{ asset('assets/img/courses.png') }}" alt="Liste des Cours" class="img-fluid">
        </div>
    </div>
</div>
</body>
