                      ...
                      <div class="mb-3">
                        ...
                        @endif
                            ...
                            @csrf
                                ...
                                <input type="email" id="email" class="form-control" name="email"  aria-describedby="emailHelp" required><br>
                                </div>
                                ...
                                <div class="mb-3">
                                <label for="disabledSelect" class="form-label" >Type de compte :</label>
