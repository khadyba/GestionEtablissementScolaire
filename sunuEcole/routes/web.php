...
// route pour la gestion des emplois du temps
    ...
    Route::get('/emplois_du_temps/create', [EmploisDuTempsController::class, 'create'])->name('emplois_du_temps.create');
    Route::post('/emplois_du_temps/upload/{classe}', [EmploisDuTempsController::class, 'store'])->name('emplois_du_temps.store');
...
// route pour les  utilisateur dejat connection 
